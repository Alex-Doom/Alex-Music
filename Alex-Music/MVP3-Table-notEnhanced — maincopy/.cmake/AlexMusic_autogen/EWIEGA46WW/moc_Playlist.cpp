...
template <> constexpr inline auto Playlist::qt_create_metaobjectdata<qt_meta_tag_ZN8PlaylistE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(size_t, double)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Playlist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->currentChanged((*reinterpret_cast< std::add_pointer_t<size_t>>(_a[1]))); break;
        case 1: _t->ratingChanged((*reinterpret_cast< std::add_pointer_t<size_t>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Playlist::*)(size_t )>(_a, &Playlist::currentChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Playlist::*)(size_t , double )>(_a, &Playlist::ratingChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void Playlist::currentChanged(size_t _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Playlist::ratingChanged(size_t _t1, double _t2)
{
