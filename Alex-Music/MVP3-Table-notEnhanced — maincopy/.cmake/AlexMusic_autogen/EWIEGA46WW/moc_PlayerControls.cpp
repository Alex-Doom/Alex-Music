...
void PlayerControls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->shuffleToggled(); break;
        case 6: _t->repeatToggled(); break;
        case 7: _t->muteToggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)()>(_a, &PlayerControls::playPause, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)()>(_a, &PlayerControls::next, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)()>(_a, &PlayerControls::prev, 2))
            return;
        ...
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)(int )>(_a, &PlayerControls::volumeChanged, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)()>(_a, &PlayerControls::shuffleToggled, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerControls::*)()>(_a, &PlayerControls::repeatToggled, 6))
            return;
...
// SIGNAL 5
void PlayerControls::shuffleToggled()
{
    QMetaObject::activate(this, &staticMetaObject, 5, nullptr);
}

// SIGNAL 6
void PlayerControls::repeatToggled()
{
